...
class PageTest(commands.Cog):
    ...
    async def pagetest_strings(self, ctx: discord.ApplicationContext):
        ...
        paginator = pages.Paginator(pages=[discord.Embed(title="help", description="help"), discord.Embed(title="please help again", description="what waht what"), discord.Embed(title="helhwwehnow", description="twegowuenoweugno")], loop_pages=True)
        await paginator.respond(ctx.interaction, ephemeral=False)
